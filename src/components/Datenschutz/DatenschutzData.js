  ...
  return (
    <div>
      ...
      <Typography>
        ...
        Datenschutzbeauftragte" oder unter: datenschutz[at]dhbw.de Die Verarbeitung dieser
        E-Mail-Adresse für Zwecke der Werbung oder der Markt- oder Meinungsforschung ist untersagt.{" "}
        <br />
      ...
      <Typography>
        ...
        jederzeit widerrufen. Durch den Widerruf der Einwilligung wird die Rechtmäßigkeit der auf
        Grund der Einwilligung bis zum Widerruf erfolgten Verarbeitung nicht berührt. <br />
        (2) Soweit wir die Verarbeitung Ihrer personenbezogenen Daten auf die Interessenabwägung
        gem. Art. 6 Abs. 1 S. 1 lit. f DS-GVO stützen, können Sie Widerspruch gegen die Verarbeitung
        einlegen. Bei Ausübung eines solchen Widerspruchs bitten wir um Darlegung der Gründe,
      ...
      <Typography>
        ...
        dienen dazu, das Internetangebot insgesamt nutzerfreundlicher und effektiver zu machen. Die
        Rechtsgrundlage für die Verarbeitung personenbezogener Daten unter Verwendung von Cookies
      ...
      <Typography>
        ...
        Nutzerprofilen verwendet. Eine dauerhafte Speicherung erfolgt nicht, die Cookies werden beim
        Schließen Ihres Browsers gelöscht (sogenannte Session Cookies).
        <br />
        ...
        und ihre Inhalte zu verbessern. Durch Analyse-Cookies erfahren wir, wie die Website genutzt
        wird und können so unser Angebot stetig optimieren.
        <br />
      </Typography>
    </div>
  );
