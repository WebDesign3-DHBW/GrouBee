  ...
  return (
    <div>
      ...
      <Typography>
        ...
        konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei bekannt werden von
        ...
        Richtigkeit der Inhalte oder die Erreichbarkeit der Web Site wird ausgeschlossen. Die Duale
        Hochschule Baden-Württemberg Mosbach haftet daher nicht für konkrete, mittelbare und
        unmittelbare Schäden oder Schäden, die durch fehlende Nutzungsmöglichkeiten, Datenverluste
        oder entgangene Gewinne entstehen können, die im Zusammenhang mit der Nutzung von Dokumenten
        oder Informationen entstehen, die auf dieser Website zugänglich sind.
      </Typography>
      ...
      <Typography>
        ...
        des Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw.
